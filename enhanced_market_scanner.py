...
def render_enhanced_market_scanner(scanner, analyzer, get_market_context):
    """
        ...
        with tab2:
            ...
            if not high_confidence.empty:
                ...
                if selected_high_conf:
                    ...
                    row = high_confidence[high_confidence["Symbol"] == selected_high_conf].iloc[0]
                    ...
                    with col1:
                            ...
                            # Noticias
                            if "Última_Noticia" in row and pd.notna(
                                row["Última_Noticia"]
                            ):
